...
export const pastEvents = [
    {
        ...
        type: 'Social',
        iconType: 'GroupIcon',
        image: '/social3-boardgame-study_spring26.png',
        description: "Join us for our club social, Yapping Points! Create mini-slides on topics of your own choosing to present in round one — but wait, the grand shuffling of slides arrives in round two...",
        registrationLink: '#',
        semester: "Spring '26"
    },
    {
        id: 'aws-s3-buckets-mar19',
        title: 'AWS Cloud Clubs: Bucket Breakthroughs',
        date: 'March 19, 2026',
        time: '12:00 PM - 1:00 PM',
        location: 'Building 163, Room 1020',
        type: 'General Meeting',
        iconType: 'SchoolIcon',
        image: '/gm7-aws-buckets-2_spring26.png',
        description: "AWS Cloud Club Meeting #2 — dive into S3 Buckets and learn how to store, manage, and access data in the cloud. A hands-on session you won't want to miss!",
        registrationLink: '#',
        semester: "Spring '26"
    },
    {
        id: 'aws-intro-pilot-mar12',
        title: 'AWS Cloud Clubs: Intro to AWS',
        date: 'March 12, 2026',
        time: '12:00 PM - 1:00 PM',
        location: 'Cal Poly Pomona',
        type: 'General Meeting',
        iconType: 'SchoolIcon',
        image: '/gm6-intro-to-aws-1_spring26.png',
        description: "The pilot meeting of the AWS Cloud Club at CPP! Join DS&AI, MISSA, CSS, and more as we kick off our cloud computing series with an introduction to Amazon Web Services.",
        registrationLink: '#',
        semester: "Spring '26"
    },
    {
    ...
    },
    {
        ...
        type: 'General Meeting',
        iconType: 'SchoolIcon',
        image: '/gm5-linux_spring26.png',
        description: "Join us as we go over Linux and the handy-dandy, ever so powerful terminal! A great session for anyone looking to level up their command-line skills.",
        registrationLink: '#',
        semester: "Spring '26"
    },
    {
